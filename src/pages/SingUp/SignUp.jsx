...
export const SignUp = () => {
  ...
  const handleSubmit = async (
    ...
    const resRegistration = await dispatch(register({ name, email, password }));

    if (resRegistration.meta.requestStatus === 'rejected') {
      alert(
        'Invalid email address or a user with this email address already exists'
      );
    } else if (resRegistration.meta.requestStatus === 'fulfilled') {
